...
- **BDPT-L**<br>BDPTに対してFidelityFX Super Resolution 2によるアップスケーリングを可能としたレンダラです（動画書き出し時にFSR2が有効であれば内部解像度を下げてレンダリングします）
- **Subayai**<br>ラスタライザベースで部分的にレイトレーシングを用いた表現力があり高速なレンダラです。動画の作成に役立ちます
- **Subayai-L**<br>Subayaiに対して、発光体からの配光を実施するレイトレーシングを追加したレンダラです。やや重くなりますが、動画の作成に役立ちます。また、FidelityFX Super Resolution 2によるアップスケーリングが可能です（動画書き出し時にFSR2が有効であれば内部解像度を下げてレンダリングします）
